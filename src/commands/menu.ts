...
async function showCodebuddyMenu(): Promise<MenuResult> {
  ...
  console.log(
    `  ${ansis.cyan('2.')} ${i18n.t('menu:menuOptions.codebuddyCheckUpdates')} ${ansis.gray(`- ${i18n.t('menu:menuDescriptions.codebuddyCheckUpdates')}`)}`,
  )
  console.log(
    `  ${ansis.cyan('3.')} ${i18n.t('menu:menuOptions.codebuddyConfigureApi')} ${ansis.gray(`- ${i18n.t('menu:menuDescriptions.codebuddyConfigureApi')}`)}`,
  )
  console.log(
    `  ${ansis.cyan('4.')} ${i18n.t('menu:menuOptions.codebuddyConfigureMcp')} ${ansis.gray(`- ${i18n.t('menu:menuDescriptions.codebuddyConfigureMcp')}`)}`,
  )
  console.log('')
  printZcfSection({
